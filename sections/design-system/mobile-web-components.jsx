...
import MobileWebImage from "../../app/images/mobile-web-components.png";


function MobileWebImageComponent() {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <>
      <motion.img
        src={MobileWebImage.src}
...
export default MobileWebImageComponent;
