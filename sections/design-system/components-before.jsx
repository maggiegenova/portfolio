...
import componentsBeforeImage from '../../app/images/components-before.png';

function ComponentsBefore() {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <>
      <motion.img
        src={componentsBeforeImage.src}
...
export default ComponentsBefore;
